...
class ValidateTransfer extends Component {
  ...
  render() {
    return this.props.transList.fetching ? (
      <LoadingSpinner />
    ) : (
      <TransfersTable
        setDefault={this.props.setDefault}
        actionState={this.props.transferAction}
        rejectDemand={this.props.rejectTransfer}
        acceptDemand={this.props.acceptTransfer}
        list={this.props.transList.list}
      />
    );
  }
}
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    acceptTransfer: id => dispatch(ValidateActions.validateTransfer(id)),
